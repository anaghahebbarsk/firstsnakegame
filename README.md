...
- Earns points for each food item eaten
- Loses the game when the snake hits the wall

The project demonstrates clean code structure using multiple Python classes.
